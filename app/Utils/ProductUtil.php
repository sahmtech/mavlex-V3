...
class ProductUtil extends Util
{
    ...
    public function calculateInvoiceTotal($products, $tax_id, $discount = null, $uf_number = true)
    {
        ...
        foreach ($products as $product) {
            ...
            // fix_tax
            // $fix_tax = 0;
            // if ($product['tax_id'] == $tax_id) {
            //     $fix_tax = $product['item_tax'];
            // } else {
            //     $fix_tax = 0;
            // }
        ...
        //     }
        // }
        // error_log('app/Utils/ProductUtil.php');
        // error_log("total_before_tax: " . $output['total_before_tax']);
        // error_log("tax: " . $output['tax']);
        // error_log("final_total: " . $output['final_total']);
        //Calculate total
        $output['final_total'] = $output['total_before_tax'] + $output['tax'] - $output['discount'];
        // error_log($output['total_before_tax'] . ' ' . $output['tax'] . ' ' . $output['final_total']);
        return $output;
    }
    /**
    ...
    public function getVariationStockDetails($business_id, $variation_id, $location_id, $adjust_current_stock = false)
    {
        ...
        if ($adjust_current_stock == 'true') {
            ...
            $update_current_stock = VariationLocationDetails::where(
                'variation_id',
                $variation_id
            )
                ->where('location_id', $location_id)
