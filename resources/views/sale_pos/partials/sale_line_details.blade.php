    ...
    @foreach ($sell->sell_lines as $sell_line)
        <tr>
            ...
            <td>
                ...
                @endif
                @if (isset($is_warranty_enabled) && $is_warranty_enabled && !empty($sell_line->warranties->first()))
                ...
                @if (in_array('kitchen', $enabled_modules))
                    <br><span
                        class="label @if ($sell_line->res_line_order_status == 'cooked') bg-red @elseif($sell_line->res_line_order_status == 'served') bg-max @else bg-light-blue @endif">@lang('restaurant.order_statuses.' . $sell_line->res_line_order_status)
                    </span>
                @endif
            </td>
            @if (session()->get('business.enable_lot_number') == 1)
