...
$(document).ready(function () {
    ...
    $(document).on("change", "input#single_dpp", function (e) {
        ...
        var tax_2_rate = $("select#tax_2").find(":selected").data("rate");
        var min_amount_2 = $("select#tax_2")
            .find(":selected")
            .data("min_amount");
        tax_2_rate = tax_2_rate == undefined ? 0 : tax_2_rate;

        var purchase_inc_tax = __add_percent(
            purchase_exc_tax,
            tax_rate,
            min_amount,
            tax_2_rate,
        ...
        var selling_price_inc_tax = __add_percent(
            selling_price,
            tax_rate,
            min_amount,
            tax_2_rate,
    ...
    $(document).on("change", "input#profit_percent", function (e) {
        ...
        var tax_2_rate = $("select#tax_2").find(":selected").data("rate");
        tax_2_rate = tax_2_rate == undefined ? 0 : tax_2_rate;
        var min_amount_2 = $("select#tax").find(":selected").data("min_amount");
