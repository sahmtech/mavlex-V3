...
return [
    ...
    "applicable_extra_tax" => "الضريبة الإضافية المطبقة",
    ...
    // 2.4
    'variation_sku_format' => 'صيغة SKU للمتغيرات',
    'variation_sku_format_help_text' => 'صيغة SKU للمتغيرات - عندما يكون SKU للمتغير فارغًا، سيتم استخدام هذه الصيغة لإنشاء SKU للمتغيرات',
    'sku_number' => 'رقم SKU (مثال -> ABC-1، ABC-2)',
    'sku_variation_number' => 'SKU للمتغير (مثال -> ABCS، ABCM)',
